/*
 * This file is part of InteractiveChat-V1_17.
 *
...
public class V1_17 extends NMSWrapper {
    ...
    public V1_17() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_17_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public boolean isWearable(ItemStack itemStack) {
        net.minecraft.world.item.ItemStack nmsItemStack = toNMSCopy(itemStack);
        EnumItemSlot slot = EntityInsentient.getEquipmentSlotForItem(nmsItemStack);
    ...
    public InternalOfflinePlayerInfo loadOfflinePlayer(UUID uuid, Inventory inventory, Inventory enderchest) {
        ...
        NBTTagCompound loadedData = player.c.getPlayerList().r.load(player);
        if (loadedData == null) {
            return null;
        }
