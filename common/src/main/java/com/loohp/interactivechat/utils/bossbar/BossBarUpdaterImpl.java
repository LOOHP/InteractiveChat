...
public class BossBarUpdaterImpl extends BossBarUpdater {
    ...
    public BossBarUpdaterImpl(BossBar bossbar, Player[] players) {
        ...
        NMS.getInstance().setBossbarTitle(bukkitBossbar, bossbar.name());
    }
    ...
    public void bossBarNameChanged(BossBar bar, Component oldName, Component newName) {
        NMS.getInstance().setBossbarTitle(bukkitBossbar, newName);
    }
