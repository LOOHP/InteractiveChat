/*
 * This file is part of InteractiveChat-V1_8_4.
 *
...
public class V1_8_4 extends NMSWrapper {
    ...
    public V1_8_4() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_8_R3.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_8_R3.ItemStack) handle);
    }

    @Override
    public net.minecraft.server.v1_8_R3.ItemStack toNMSCopy(ItemStack itemstack) {
    ...
    public ItemStack getItemFromNBTJson(String json) {
        try {
            ...
            net.minecraft.server.v1_8_R3.ItemStack itemStack = net.minecraft.server.v1_8_R3.ItemStack.createStack(nbtTagCompound);
