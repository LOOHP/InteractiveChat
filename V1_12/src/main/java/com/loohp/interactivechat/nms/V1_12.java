/*
 * This file is part of InteractiveChat-V1_12.
 *
...
public class V1_12 extends NMSWrapper {
    ...
    public V1_12() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_12_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
            entityPlayerCanChatColorField = EntityPlayer.class.getDeclaredField("cm");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_12_R1.ItemStack) handle);
    }
    ...
    public Key getNMSItemStackNamespacedKey(ItemStack itemStack) {
        ...
        return minecraftkey == null ? Key.key("minecraft", "air") : Key.key(minecraftkey.b(), minecraftkey.getKey());
    }
    ...
    public void sendFakePlayerInventory(Player player, Inventory inventory, boolean armor, boolean offhand) {
        ...
        NonNullList<net.minecraft.server.v1_12_R1.ItemStack> itemList = NonNullList.a();
