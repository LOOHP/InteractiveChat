...
import net.minecraft.server.v1_14_R1.ItemSkullPlayer;
...
import net.minecraft.server.v1_14_R1.PacketPlayOutTabComplete;
...
import org.bukkit.craftbukkit.v1_14_R1.map.RenderData;
...
public class V1_14 extends NMSWrapper {
    ...
    public V1_14() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_14_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_14_R1.ItemStack) handle);
    }

    @Override
    public net.minecraft.server.v1_14_R1.ItemStack toNMSCopy(ItemStack itemstack) {
        return CraftItemStack.asNMSCopy(itemstack);
    }

    @Override
    public Component getItemStackDisplayName(ItemStack itemStack) {
        net.minecraft.server.v1_14_R1.ItemStack nmsItemStack = toNMSCopy(itemStack);
    ...
    public Component getSkullOwner(ItemStack itemStack) {
        ...
        IChatBaseComponent owner = skull.g(nmsItemStack);
    ...
    public ItemStack getItemFromNBTJson(String json) {
        try {
            ...
            net.minecraft.server.v1_14_R1.ItemStack itemStack = net.minecraft.server.v1_14_R1.ItemStack.a(nbtTagCompound);
    ...
    public void sendFakePlayerInventory(Player player, Inventory inventory, boolean armor, boolean offhand) {
        ...
        NonNullList<net.minecraft.server.v1_14_R1.ItemStack> itemList = NonNullList.a();
