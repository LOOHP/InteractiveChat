/*
 * This file is part of InteractiveChat-V1_18.
 *
...
public class V1_18 extends NMSWrapper {
    ...
    public V1_18() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_18_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public Component getSkullOwner(ItemStack itemStack) {
        net.minecraft.world.item.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(itemStack);
        ItemSkullPlayer skull = (ItemSkullPlayer) nmsItemStack.c();
    ...
    public boolean isArmor(ItemStack itemStack) {
        net.minecraft.world.item.ItemStack nmsItemStack = toNMSCopy(itemStack);
        return nmsItemStack.c() instanceof ItemArmor;
    }
    ...
    public InternalOfflinePlayerInfo loadOfflinePlayer(UUID uuid, Inventory inventory, Inventory enderchest) {
        ...
        NBTTagCompound loadedData = player.c.ac().r.b(player);
        if (loadedData == null) {
            return null;
        }
