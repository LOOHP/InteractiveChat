...
import net.minecraft.server.v1_13_R2.ItemSkullPlayer;
...
public class V1_13_1 extends NMSWrapper {
    ...
    public V1_13_1() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_13_R2.inventory.CraftMetaSkull").getDeclaredField("profile");
            entityPlayerCanChatColorField = EntityPlayer.class.getDeclaredField("ct");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_13_R2.ItemStack) handle);
    }

    @Override
    public net.minecraft.server.v1_13_R2.ItemStack toNMSCopy(ItemStack itemstack) {
        return CraftItemStack.asNMSCopy(itemstack);
    }

    @Override
    public Component getItemStackDisplayName(ItemStack itemStack) {
        net.minecraft.server.v1_13_R2.ItemStack nmsItemStack = toNMSCopy(itemStack);
    ...
    public ItemStack getItemFromNBTJson(String json) {
        try {
            ...
            net.minecraft.server.v1_13_R2.ItemStack itemStack = net.minecraft.server.v1_13_R2.ItemStack.a(nbtTagCompound);
    ...
    public void sendFakePlayerInventory(Player player, Inventory inventory, boolean armor, boolean offhand) {
        ...
        NonNullList<net.minecraft.server.v1_13_R2.ItemStack> itemList = NonNullList.a();
