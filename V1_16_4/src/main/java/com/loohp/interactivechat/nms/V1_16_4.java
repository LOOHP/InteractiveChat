/*
 * This file is part of InteractiveChat-V1_16_4.
 *
...
public class V1_16_4 extends NMSWrapper {
    ...
    public V1_16_4() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_16_R3.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_16_R3.ItemStack) handle);
    }

    @Override
    public net.minecraft.server.v1_16_R3.ItemStack toNMSCopy(ItemStack itemstack) {
        return CraftItemStack.asNMSCopy(itemstack);
    }

    @Override
    public Component getItemStackDisplayName(ItemStack itemStack) {
        net.minecraft.server.v1_16_R3.ItemStack nmsItemStack = toNMSCopy(itemStack);
    ...
    public void sendFakePlayerInventory(Player player, Inventory inventory, boolean armor, boolean offhand) {
        ...
        NonNullList<net.minecraft.server.v1_16_R3.ItemStack> itemList = NonNullList.a();
    ...
    public void sendFakeMainHandSlot(Player player, ItemStack item) {
        List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R3.ItemStack>> nmsEquipments = Collections.singletonList(new Pair<>(EnumItemSlot.MAINHAND, toNMSCopy(item)));
