...
public class RarityUtils {
	...
	public static void setupRarity() {
		try {
			...
			nmsEnumItemRarityClass = NMSUtils.getNMSClass("net.minecraft.server.", "EnumItemRarity");
			nmsEnumChatFormatClass = NMSUtils.getNMSClass("net.minecraft.server.", "EnumChatFormat");
