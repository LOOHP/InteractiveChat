...
public class V1_13 extends NMSWrapper {
    ...
    public V1_13() {
        try {
            ...
            craftSkullMetaProfileField = Class.forName("org.bukkit.craftbukkit.v1_13_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
            entityPlayerCanChatColorField = EntityPlayer.class.getDeclaredField("cu");
    ...
    public ItemStack toBukkitCopy(Object handle) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_13_R1.ItemStack) handle);
    }
    ...
    public Component getItemStackDisplayName(ItemStack itemStack) {
        net.minecraft.server.v1_13_R1.ItemStack nmsItemStack = toNMSCopy(itemStack);
    ...
    public boolean isWearable(ItemStack itemStack) {
        net.minecraft.server.v1_13_R1.ItemStack nmsItemStack = toNMSCopy(itemStack);
        EnumItemSlot slot = EntityInsentient.e(nmsItemStack);
    ...
    public ItemStack getItemFromNBTJson(String json) {
        try {
            ...
            net.minecraft.server.v1_13_R1.ItemStack itemStack = net.minecraft.server.v1_13_R1.ItemStack.a(nbtTagCompound);
    ...
    public void sendToast(IICPlayer sender, Player pinged, String messageJson, ItemStack icon) {
        ...
        IChatBaseComponent componentTitle = IChatBaseComponent.ChatSerializer.a(messageJson);
    ...
    public void sendFakePlayerInventory(Player player, Inventory inventory, boolean armor, boolean offhand) {
        ...
        NonNullList<net.minecraft.server.v1_13_R1.ItemStack> itemList = NonNullList.a();
